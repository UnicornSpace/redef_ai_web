...
export interface Profile {
  ...
  /** Opt-in for the aggregate habit heatmap on /u/[username]. Default TRUE
      on the DB side; see migration 20260812_profile_public_activity_flag.sql. */
  public_activity_visible: boolean;
