      ...
      <div className="self-stretch h-auto flex flex-col md:flex-row justify-between items-stretch pr-0 pb-8 pt-0">
        <div className="h-auto p-4 md:p-8 flex flex-col justify-start items-start gap-8">
          ...
          <div className="self-stretch flex justify-start items-center gap-3">
            <div className="text-center flex items-center text-[#49423D] text-xl font-semibold leading-4 font-sans">
              <Image src={"/logo.png"} height={40} width={40} alt="" />
              <span className="-ml-2">edef AI</span>
            </div>
          </div>
          ...
          <div className="flex justify-start items-start gap-2">
            ...
            <div className="w-6 h-6 relative overflow-hidden">
              <Link href={"https://x.com/mohdfaizan_5"} className="w-6 h-6 left-0 top-0 absolute flex items-center justify-center">
                <FaXTwitter />
              </Link>
            </div>
            <div className="w-6 h-6 relative overflow-hidden">
              <Link href={"https://x.com/_likitha_n"} className="w-6 h-6 left-0 top-0 absolute flex items-center justify-center">
                <FaXTwitter />
              </Link>
              <Badge variant={"outline"} className="absolute -right-2 -top-2">2</Badge>
            </div>
        ...
        <div className="self-stretch p-4 md:p-8 flex flex-col sm:flex-row flex-wrap justify-start sm:justify-between items-start gap-6 md:gap-8">
          ...
          <div className="flex flex-col justify-start items-start gap-3 flex-1 min-w-[120px]">
            ...
            <div className="flex flex-col justify-end items-start gap-2">
              ...
              <Link href={"/waitlist"} className="text-[#49423D] text-sm font-normal leading-5 font-sans cursor-pointer hover:text-[#37322F] transition-colors">
                Waitlist
              </Link>
              <div className="text-[#49423D] text-sm font-normal leading-5 font-sans cursor-pointer hover:text-[#37322F] transition-colors">
                Why invest on productivity
              </div>
              {/* <div className="text-[#49423D] text-sm font-normal leading-5 font-sans cursor-pointer hover:text-[#37322F] transition-colors">
                Multi-Agent Coding
              </div> */}
