      ...
      <div className="self-stretch px-6 md:px-24 py-12 md:py-12 border-t border-b border-[rgba(55,50,47,0.12)] flex justify-center items-center gap-6 relative z-10">
        ...
        <div className="w-full max-w-[586px] px-6 py-5 md:py-8 overflow-hidden rounded-lg flex flex-col justify-start items-center gap-6 relative z-20">
          <div className="self-stretch flex flex-col justify-start items-start gap-3">
            <div className="self-stretch font-serif text-center flex justify-center flex-col text-[#49423D] text-3xl md:text-5xl font-medium leading-tight md:leading-12 tracking-tight">
              Ready to take control of your productivity?
            </div>
            <div className="self-stretch text-center text-[#605A57] text-base leading-6 font-sans font-medium">
