...
export default function TestimonialsSection() {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      image:
        "/faizan-founder-unicornspace.png",
    },
    // {
    //   quote:
    //     "The old way was manual chaos—juggling tools, losing track, burning out. This system gives me clarity. I say what matters, it handles the rest. It's not just productivity, it's peace of mind.",
      ...
      <div className="self-stretch px-2 overflow-hidden flex justify-start items-center border border-b border-l-0 border-r-0 border-t-0">
        <div className="flex-1 py-16 md:py-17 flex flex-col md:flex-row justify-center items-end gap-6">
          <div className="self-stretch px-3 md:px-12 justify-center items-start gap-4 flex flex-col md:flex-row">
            ...
            />
            <div className="flex-1 px-6 py-6 shadow-[0px_0px_0px_0.75px_rgba(50,45,43,0.12)] overflow-hidden flex flex-col justify-start items-start gap-4 shadow-none pb-0 pt-0">
              <div
                className="self-stretch justify-start flex flex-col text-[#49423D] text-2xl md:text-[32px] font-normal leading-8 md:leading-[42px] font-serif h-[200px] md:h-[210px] overflow-hidden line-clamp-5 transition-all duration-700 ease-in-out tracking-tight"
                style={{
              ...
              <div
                className="self-stretch flex flex-col justify-start items-start gap-0 transition-all duration-700 ease-in-out"
                style={{
                  filter: isTransitioning ? "blur(4px)" : "blur(0px)",
                  transition: "filter 0.7s ease-in-out",
                }}
              >
                ...
                <div className="self-stretch -mt-1 justify-center flex flex-col text-[rgba(73,66,61,0.70)] text- font-medium leading-[26px] font-sans">
